return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader><Tab>", ":BufferLineCycleNext<CR>", { noremap = true, silent = true, desc = "Chuyển sang buffer tiếp theo" })
    vim.keymap.set("n", "<leader><S-Tab>", ":BufferLineCyclePrev<CR>", { noremap = true, silent = true, desc = "Chuyển sang buffer trước đó" })
    vim.keymap.set("n", "<leader>w", close_current_buffer, { noremap = true, silent = true, desc = "Đóng buffer hiện tại" })
  end,
}
